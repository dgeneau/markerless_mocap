...
if session_date == 'Feb 21':
    ...
    if trial == 'Running 3.6 m/s': 
        ...
        video = f'Collection {session_date}/Session_3/{session_id}/Videos/InputMedia/run_3_6_1/run_3_6_1_sync.mp4'
        start = 0
        treadmill_vel = 3.6
        plate = 1
        ...
        video = f'Collection {session_date}/Session_3/{session_id}/Videos/InputMedia/run_3_6_3Que/run_3_6_3Que_sync.mp4'
        start = 0
        treadmill_vel = 3.6
        plate = 1
        ...
        video = f'Collection {session_date}/Session_3/{session_id}/Videos/InputMedia/run_3_6bendtoes_2/run_3_6bendtoes_2_sync.mp4'
        start = 0
        treadmill_vel = 3.6
        plate = 1
        ...
        video = f'Collection {session_date}/Session_3/{session_id}/Videos/InputMedia/run_3_6ringpits/run_3_6ringpits_sync.mp4'
        start = 0
        treadmill_vel = 3.6
        plate = 1
        ...
        video = f'Collection {session_date}/Session_3/{session_id}/Videos/InputMedia/run_5_5/run_5_5_sync.mp4'
        start = 0
        treadmill_vel = 5.5
        plate = 1
        ...
        video = f'Collection {session_date}/Session_3/{session_id}/Videos/InputMedia/run_5_5_3que/run_5_5_3que_sync.mp4'
        start = 0
        treadmill_vel = 5.5
        plate = 1
        ...
        video = f'Collection {session_date}/Session_3/{session_id}/Videos/InputMedia/run_5_5ringpits/run_5_5ringpits_sync.mp4'
        start = 0
        treadmill_vel = 5.5
        plate = 1
